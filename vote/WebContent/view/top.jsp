...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="skin/images/frame/topbg.gif">
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <tr>
      <td align="right" height="60" style="padding-right:10px;line-height:26px;font-size:15px;font-weight:500">
        	<b>您好，</b><span class="username"><b><%=session.getAttribute("userName") %></b></span><b>，欢迎使用课堂评分统计系统！</b>
			<a  href="./createSub.jsp" target="main"><b>[创建子用户密钥]</b></a>
			<a href="./modifyPsw.jsp" target="main" ><b>[修改密码]</b></a>
        	<a href="user/exit.jsp" target="_top"><b>[注销退出]</b></a>
