...
<script type="text/javascript">
	...
	function btnBack_onclick() {
		<% if( session.getAttribute("radioFlag").equals("1") ){
		%>
										...
										<td colspan="5">
											<form method="post" action="" name="myForm">
												...
												<table class="table2">
													...
													<tr>
									<td>
									请输入学号：<input placeholder="学号"  type="text" id="studentid_0" name="studentid_0" onblur="check()" onkeyup="value=value.replace(/\D/g,'')"/><br/>
									请输入姓名：<input placeholder="姓名"  type="text" id="studentname_0" name="studentname_0" onblur="check()"/>
									<br/><font color="red" id="studentinfo" name="studentinfo" > </font>
									</td>
									</tr>
												</table>
											</form>
